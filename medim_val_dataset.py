...
if __name__ == "__main__":
    ...
    test_data_list = [
        dict(
            img_dir="data/Task204_picai_lesion/imagesTr",
            gt_dir="data/Task204_picai_lesion/labelsTr",
            out_dir="data/Task204_picai_lesion/pred_sammed3d",
            ckpt_path="work_dir/Task204_picai_lesion/sam_model_dice_best.pth",
        ),
    ]
